...
const PageSearch: NextPage<Props> = ({ articles, dataTags, lastNews, searchText, nextArticles, meta, ads }) => {
  ...
  const _article = useMemo<IMeta>(
    () => ({
      ...meta,
      title: `ผลการค้นหา ${searchText} ล่าสุด ติดตามข่าว ${searchText}`,
      description: `ค้นหาข่าวเกี่ยวกับ ${searchText} ล่าสุด ติดตามข่าว ${searchText} ข่าวด่วน ${searchText} เรื่องราวเกี่ยวกับ ${searchText} ข่าวที่เกี่ยวข้อง ${searchText} - โพสต์ทูเดย์`,
